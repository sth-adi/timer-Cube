...
import { CheckCircle2, Dumbbell, Eye, Loader2, SkipForward, Timer as TimerIcon, Trophy, XCircle } from "lucide-react";
      ...
      <div className="card flex min-h-[220px] flex-col items-center justify-center gap-3 rounded-xl p-5 text-center">
        {phase === "idle" && (
          <>
            ...
            <p className="max-w-xs text-xs text-muted">
              ...
              algorithm. Weak and slow cases come up more.
            </p>
        ...
        {(phase === "go" || phase === "exec") && (
          <>
            ...
            <p className="text-[11px] text-muted">Hold it yellow on top, recognize the {current?.group}, and solve it. The clock is already running.</p>
          </>
        )}
